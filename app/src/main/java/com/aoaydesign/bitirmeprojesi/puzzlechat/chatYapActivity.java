...
public class chatYapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvBaslik= (TextView) findViewById(R.id.textodaismi);
        et_mesaj= (EditText) findViewById(R.id.mesaj);
        buttonGonder= (Button) findViewById(R.id.gonder);
        lv_chatyap= (ListView) findViewById(R.id.lwchatyap);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(resimSec,GALLERY_INTENT);
            }
        });
        ...
        final String oda= getIntent().getStringExtra("odaKey");
        ...
        buttonGonder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                et_mesaj.setText("");
                database.getReference().child("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(oda).setValue(true);
            }
        });
